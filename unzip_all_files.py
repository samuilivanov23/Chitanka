...
#extract zips for single author

# author_name = "ivan-vazov"

# for my_file in os.listdir("../books/" + author_name):
#         if my_file.endswith(".zip"):
#             file_location = "../books/" + author_name + "/" + my_file
#             dir_location = "../books/" + author_name + "/"
#             print(file_location)
#             zip_file = zipfile.ZipFile(file_location, mode="r")
#             zip_file.extractall(path=dir_location, pwd='samuil123'.encode('utf-8'))
#             zip_file.close()
